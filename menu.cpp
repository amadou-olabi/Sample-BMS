...
{
    if(strcmp(menu,"BMS")==0 || strcmp(menu,"bms")==0)
    {
        system("cls");
        printf("\n\n\n");
        cout << "     ===============================================\n     ||                                           ||" << endl;
...
void loadBar(int option)
{
    ...
    case 3:
        printf("%s\n", "");
        Sever_Connection(0,5,"Loading Data");
        for (; num_secs <= 5; ++num_secs)
        {
            my_wait("medium");
            Sever_Connection(num_secs, 5,"Loading Data");
        }
        break;
    case 4:
        printf("%s\n", "");
        Sever_Connection(0,5,"Connecting Server");
        for (; num_secs <= 5; ++num_secs)
        {
            my_wait("short");
            Sever_Connection(num_secs, 5,"Connecting Server");
        }
        break;
    }
...
void welcome_message()
{
    ...
    */
    ...
    printf("\n\t                  Ashraf Gamal Hatem  \t    [ID : 160040001]\n");
    printf("\n\t                  Abdul Aziz Yousufzai \t    [ID : 160040004]\n");
    printf("\n\t                  Latifa Atayee \t    [ID : 160040002]\n");
    gotoxy(1,21);
    printf("______________________________________________________________________________\n");
...
AUTHENTIF *user_authentif(int option)///*GUI of Authentication {1 = Client and 2 = Admins or Staffs}
{
    AUTHENTIF *user;
    user = (AUTHENTIF *)malloc(sizeof(AUTHENTIF));
    if(option==1) ///*Client ID
    {
        char username[50];
        char password[50]="";
        char ch;
    ...
    else if(option==2) ///*Admins or Staffs
    {
        char username[50];
        char password[50]="";
        char ch;
